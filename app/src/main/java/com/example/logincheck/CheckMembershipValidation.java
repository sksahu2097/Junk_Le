...
public class CheckMembershipValidation {

    final static String LOGIN_BASE_URL = IPAddressSetting.ipAddress()+"/checkMembership";

    final static String PARAM_QUERY1 = "userid";

    public static URL buildUrl(String username) {
