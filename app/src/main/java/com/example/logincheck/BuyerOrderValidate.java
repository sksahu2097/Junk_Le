...
public class BuyerOrderValidate {

    final static String LOGIN_BASE_URL = IPAddressSetting.ipAddress()+"/buyerOrder";
    ...
    final static String PARAM_QUERY5 = "dop";

    public static URL buildUrl(String username, String category, String quantity , String price, String dop) {
        Uri builtUri = Uri.parse(LOGIN_BASE_URL).buildUpon()
                ...
                .appendQueryParameter(PARAM_QUERY5, dop)
                .build();
